          ...
          <AnimatePresence mode="wait">
            {!isExpanded ? (
              ...
              <motion.div
                ...
                className="relative w-[240px] h-[300px] sm:w-[280px] sm:h-[350px] md:w-[320px] md:h-[400px]"
              >
  ...
  "
              ...
              >
                {projects.map((project, index) => (
                  <motion.div
                    ...
                    className="relative group h-[260px] sm:h-[300px] lg:h-[320px] rounded-[1.8rem] overflow-hidden bg-zinc-900 border border-white/5 cursor-zoom-in"
                  >
                    <img
                      src={project.img}
                    ...
                    <div className="absolute bottom-0 inset-x-0 p-4 sm:p-5 z-30 opacity-0 group-hover:opacity-100 transition-all duration-500">
                      <div className="bg-black/60 backdrop-blur-xl border border-white/10 p-3 sm:p-4 rounded-2xl flex justify-between items-center text-white">
                        <p className="font-bold text-sm">{project.title}</p>
                        <span className="text-[#088395] text-[9px] uppercase tracking-widest">
                          {project.category}
                        </span>
                      </div>
                    </div>
      ...
      <AnimatePresence>
        {selectedImg && (
          ...
          >
            <button className="absolute top-6 right-6 sm:top-8 sm:right-8 text-white/50 hover:text-white transition-colors">
              <X size={32} />
            </button>
            ...
            <motion.img
              ...
              src={selectedImg}
              className="max-w-full max-h-[85vh] sm:max-h-[90vh] rounded-2xl shadow-2xl border border-white/10"
